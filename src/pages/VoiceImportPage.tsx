...
import VoiceImport from '../components/import/VoiceImport.tsx';
...
export default function VoiceImportPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      {!parsed ? (
        ...
        <>
          <p className="text-sm text-secondary-500 mb-4">レシピに変換しました。内容を確認・修正してから保存してください。</p>
